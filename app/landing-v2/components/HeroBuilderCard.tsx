...
type TabKey = "Fermentables" | "Mash" | "Hops" | "Yeast" | "Water" | "Boil";

const TABS: { label: TabKey; enabled: boolean }[] = [
...
export default function HeroBuilderCard({
  ...
  return (
    ...
    >
      ...
      {/* Section card — fixed height + absolute panels so swaps never reflow
          the page or push the hero text on the left. */}
      <div
        style={{
          position: "relative",
